...
╔════❰ ғᴏʀᴡᴀʀᴅ ʙᴏᴛ ❱═❍⊱❁۪۪
║╭━━━━━━━━━━━━━━━➣
║┣⪼📃ʙᴏᴛ : [Fᴏʀᴡᴀᴅ Bᴏᴛ](https://t.me/autoforwardmagicbot)
║┣⪼👦Cʀᴇᴀᴛᴏʀ : [✇𝘷ᎨʂhαℓⓋ︎](https://t.me/ig_magic)
║┣⪼🤖Uᴘᴅᴀᴛᴇ : [YΣ - ᄂΣΛ](https://t.me/MAGICxBots)
║┣⪼📡Hᴏsᴛᴇᴅ ᴏɴ : Sᴜᴘᴇʀ Fᴀsᴛ (render)
║┣⪼🗣️Lᴀɴɢᴜᴀɢᴇ : Pʏᴛʜᴏɴ3
...
║┃
║┣⪼<a href="tg://user?id={BOT_OWNER}">𓍯𓂃𓏧♡ —͞𖣘</a>
║╰━━━━━━━━━━━━━━━➣ 
╚════❰ {} ❱══❍⊱❁۪۪
"""
  DUPLICATE_TEXT = """
